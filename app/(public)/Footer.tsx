...
export default function Footer() {
  return (
    <footer
      className="bg-white text-gray-700 pt-10 pb-5 px-5 md:px-10 mt-10"
      role="contentinfo"
...
{/* TODO */}
        ...
        >
          <Link href="/" className="flex items-center mb-4" aria-label="بازگشت به صفحه اصلی">
            <Image
              width={45}
              height={45}
            ...
            />
            <h2
              className="text-black mx-2 font-semibold text-xl hover:scale-105"
            >
              Kerman Atari
            </h2>
          </Link>
          ...
          <p className="text-sm text-gray-700 leading-6 mb-2">
            خرید و فروش بازی‌های پلی‌استیشن، کنسول و اکانت‌های دیجیتالی با بهترین قیمت در کرمان.
          </p>
      ...
      {/* نوار پایینی */}
      <div className="flex flex-col md:flex-row items-center justify-between border-t border-gray-700 pt-4 text-sm">
            ...
            {menuItems.map((item, i) => {
              ...
              return (
                <li key={i} className="cursor-pointer flex items-center">
                  <Link href={item.href} className="flex items-center hover:text-red-500 transition">
